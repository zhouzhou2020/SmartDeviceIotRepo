...
public class IirFilterDesignFisher {
    ...
    private static IirFilterDesignFisher.PolesAndZeros normalize(Complex[] var0, FilterPassType var1, double var2, double var4, boolean var6) {
        ...
        if (var2 > 0.0D && var2 < 0.5D) {
            if (var8 && (var4 <= 0.0D || var4 >= 0.5D)) {
                ...
                double var17;
                double var19;
                IirFilterDesignFisher.PolesAndZeros var21;
                int var22;
                Complex var23;
                Complex var24;
                IirFilterDesignFisher.PolesAndZeros var25;
                switch(var1) {
                case lowpass:
//                    var25 = new IirFilterDesignFisher.PolesAndZeros((SyntheticClass_1)null);
                    var25 = new IirFilterDesignFisher.PolesAndZeros();
...
//                    var21 = new IirFilterDesignFisher.PolesAndZeros((SyntheticClass_1)null);
                    var21 = new IirFilterDesignFisher.PolesAndZeros();
...
//                    var21 = new IirFilterDesignFisher.PolesAndZeros((SyntheticClass_1)null);
    ...
    private static IirFilterDesignFisher.PolesAndZeros MapSPlaneToZPlane(IirFilterDesignFisher.PolesAndZeros var0, IirFilterDesignFisher.SToZMappingMethod var1) {
        IirFilterDesignFisher.PolesAndZeros var2;
        switch(var1) {
        case bilinearTransform:
//            var2 = new IirFilterDesignFisher.PolesAndZeros((SyntheticClass_1)null);
            var2 = new IirFilterDesignFisher.PolesAndZeros();
...
//            var2 = new IirFilterDesignFisher.PolesAndZeros((SyntheticClass_1)null);
    ...
    private static PolynomialUtils.RationalFraction computeTransferFunction(IirFilterDesignFisher.PolesAndZeros var0) {
    ...
    public static IirFilterCoefficients design(FilterPassType var0, FilterCharacteristicsType var1, int var2, double var3, double var5, double var7) {
        ...
        boolean var11 = var10 == IirFilterDesignFisher.SToZMappingMethod.bilinearTransform;
        IirFilterDesignFisher.PolesAndZeros var12 = normalize(var9, var0, var5, var7, var11);
        IirFilterDesignFisher.PolesAndZeros var13 = MapSPlaneToZPlane(var12, var10);
