...
public class PolynomialRootFinderJenkinsTraub {
    ...
    public static Complex[] findRoots(double[] var0) {
        GlobalEnvironment var1 = new GlobalEnvironment();
    ...
    private static class GlobalEnvironment {
                            ...
                            while(true) {
                                while(true) {
                                    ...
                                    case 20:
                                        ...
                                        break;
                                    case 40:
                                        RealitOut var52 = this.realit(var50);
                                        if (var52.nz > 0) {
                                            return var52.nz;
                                        }
        ...
        private RealitOut realit(double var1) {
            double var3 = 0.0D;
            double var5 = 0.0D;
            double var7 = var1;
            int var9 = 0;
            ...
            while(true) {
                ...
                if (var21 <= 20.0D * (4.44E-16D * var16 - 2.22E-16D * var21)) {
                    ...
                    return new RealitOut(var1, 1, false);
                }

                ++var9;
                if (var9 > 10) {
                    return new RealitOut(var1, 0, false);
                }

                if (var9 >= 2 && Math.abs(var5) <= 0.001D * Math.abs(var7 - var5) && var21 > var3) {
                    return new RealitOut(var7, 0, true);
                }
